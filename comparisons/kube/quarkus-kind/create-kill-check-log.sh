...
echo "Number of connection refused / Total number of requests " >> logall.log
echo "   Spring-boot: $NB_SB_FAULTS / $REQUESTS_SB" >> logall.log
echo "   Spring-boot native: $NB_SB_NATIVE_FAULTS / $REQUESTS_SB_NATIVE" >> logall.log
echo "   Quarkus standard JVM: $NB_QK_JVM_FAULTS / $REQUESTS_QK_JVM" >> logall.log
echo "   Quarkus GraalVM: $NB_QK_NATIVE_FAULTS / $REQUESTS_QK_NATIVE" >> logall.log
